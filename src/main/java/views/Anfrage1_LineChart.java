...
import static jFreeChart.Anfrage1_LineChartCreator.*;
...
public class Anfrage1_LineChart {

	public static void main(String[] args) {
		
		// Anfrage-Ergebnisse direkt von der Datenbank holen
//		AnfragenDBzuList db2List = new AnfragenDBzuList();
//		List<Anfrage1> list = (List<Anfrage1>)db2List.getDataFromDB(Anfragen.Anfrage1);
		
		// Anfrage-Ergebnisse von Datei lesen
		List<Anfrage1> list = readEntitiesFromAnfrage1();
				
		JFreeChart chart = createAnfrage1Chart(list);
		ChartPanel chartPanel = new ChartPanel(chart);
	    chartPanel.setPreferredSize(new java.awt.Dimension(500, 270));
	   	ApplicationFrame appFrame = new ApplicationFrame("Anfrage1");
	...
	public static List<Anfrage1> readEntitiesFromAnfrage1() {
		return (List<Anfrage1>)readEntitiesFromFile(Anfrage1.class, new File("./src/test/resources/result_anfrage1.txt"));
	}
