...
import static jFreeChart.Anfrage5_BarChartHorizontalCreator.*;
...
public class Anfrage5_BarChart {

	public static void main(String[] args) {
		
		// Anfrage-Ergebnisse direkt von der Datenbank holen
//		AnfragenDBzuList db2List = new AnfragenDBzuList();
//		List<Anfrage5> list = (List<Anfrage5>)db2List.getDataFromDB(Anfragen.Anfrage5);
		
		// Anfrage-Ergebnisse von Datei lesen
		List<Anfrage5> list = readEntitiesFromAnfrage5();
				
		JFreeChart chart = createAnfrage5Chart(list);
		ChartPanel chartPanel = new ChartPanel(chart);
	    chartPanel.setPreferredSize(new java.awt.Dimension(500, 270));
	   	ApplicationFrame appFrame = new ApplicationFrame("Anfrage5");
	...
	public static List<Anfrage5> readEntitiesFromAnfrage5() {
		return (List<Anfrage5>)readEntitiesFromFile(Anfrage5.class, new File("./src/test/resources/result_anfrage5.txt"));
	}
